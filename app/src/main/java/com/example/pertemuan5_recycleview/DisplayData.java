...
import com.example.pertemuan5_recycleview.databinding.ActivityDisplayData2Binding;
...
public class DisplayData extends AppCompatActivity {
    ...
    MyAdapter myAdapter;
    private ActivityDisplayData2Binding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding =
                ActivityDisplayData2Binding.inflate(getLayoutInflater());
